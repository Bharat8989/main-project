...
const mockPapers = [
  {
    ...
    paperYear: 2025,
    fileId: "file-1",
    url: "https://example.com/de-2025-w.pdf",
  },
  {
    id: 2,
    ...
    paperYear: 2024,
    fileId: "file-2",
    url: "https://example.com/ct-2024-w.pdf",
  },
];
    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-slate-100 p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-6 flex items-center gap-2 text-sm text-slate-600">
          ...
          <span>/</span>
          <Link href="/entc" className="hover:text-purple-600">
            ENTC
          </Link>
          <span>/</span>
        ...
        <div className="space-y-4">
          {filteredPapers.length > 0 ? (
            filteredPapers.map((paper) => (
              <div
                key={paper.id}
                className="bg-white rounded-lg shadow-md hover:shadow-lg transition p-5 border-l-4 border-purple-600"
              >
                <div className="flex items-start justify-between gap-4">
                  ...
                  <div className="flex gap-2">
                    ...
                    <button className="px-4 py-2 border-2 border-purple-600 text-purple-600 rounded-lg hover:bg-purple-50 transition font-medium">
                      Preview
                    </button>
                  </div>
                </div>
