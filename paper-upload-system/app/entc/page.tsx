    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-slate-100 p-6">
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-slate-600">Browse Electronics & Telecom Engineering papers by year and semester</p>
        </div>
                      ...
                      <div className="mb-5">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {years.map((yr) => (
                            <Link
                              key={`w-${yr}`}
                              href={`/entc/papers?year=${yearIndex + 1}&sem=${actualSem}&season=Winter&paperYear=${yr}`}
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {years.map((yr) => (
                            <Link
                              key={`s-${yr}`}
                              href={`/entc/papers?year=${yearIndex + 1}&sem=${actualSem}&season=Summer&paperYear=${yr}`}
