      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-green-600 mb-2">
            📊 Information Engineering – Question Papers
          </h1>
          <p className="text-slate-600">Browse Information Engineering papers by year and semester</p>
        </div>
                      ...
                      <div className="mb-5">
                        ...
                        <div className="flex flex-wrap gap-2">
                          {years.map((yr) => (
                            <Link
                              key={`w-${yr}`}
                              href={`/ie/papers?year=${yearIndex + 1}&sem=${actualSem}&season=Winter&paperYear=${yr}`}
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {years.map((yr) => (
                            <Link
                              key={`s-${yr}`}
                              href={`/ie/papers?year=${yearIndex + 1}&sem=${actualSem}&season=Summer&paperYear=${yr}`}
